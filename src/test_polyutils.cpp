...
void test_fftMulPoly (typename PolyUtils::Poly<AltBn128::Engine>::FrElementMatrix vector1, typename PolyUtils::Poly<AltBn128::Engine>::FrElementMatrix vector2, FFT<AltBn128::Fr>* fft) {
